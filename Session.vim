...
set laststatus=2
set ruler
set runtimepath=~/.vim,~/.vim/bundle/jedi-vim,~/.vim/bundle/nerdtree,~/.vim/bundle/vim-erlang-omnicomplete,~/.vim/bundle/vim-nerdtree-tabs,~/.vim/bundle/vim-signify,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim80,/usr/local/share/vim/vimfiles/after,~/.vim/bundle/jedi-vim/after,~/.vim/after
set showcmd
...
silent only
cd ~/Projects/escript_boilerplate
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 main.escript
badd +77 ~/Projects/bash3boilerplate/main.sh
argglobal
silent! argdel *
argadd main.escript
edit ~/Projects/bash3boilerplate/main.sh
